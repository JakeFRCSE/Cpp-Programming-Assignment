...
public:
    Rectangle(float p1x, float p1y, float p2x, float p2y): p1(p1x, p1y), p2(p2x, p2y) {} // implement it
    Rectangle() {};
...
public:
    Square(float px, float py, float side): p(px, py), side(side) {}// implement here
    Square() {}
